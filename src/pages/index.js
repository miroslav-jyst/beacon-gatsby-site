    ...
    <>
      <Layout>
        ...
        <ImageText1 
          id="how-it-works"
          title="How it works?"
          text="Beacon allows you to create tailored employee wellness plans at scale. One simple app that allows you to  create bespoke employee wellbeing programmes for a modern workforce. Creating wellness flows help alleviate stressors before they manifest into large problems. Tailor scientifically verified articles, videos, content and provide your team with the tools to improve stress and anxiety that exists in the workspace."
        />
